...
public class myuploads extends Fragment implements OnItemClickListener{
    ...
    private void prepareStaredItems() {
        ...
        ar[0]= new File(new Long(1234567891),new Long(600122),new Long(21),5,4,"pdf","eccf notes",new Date(01/01/1997),"fgdfg");
        ar[1]= new File(new Long(1234567891),new Long(6122),new Long(21),5,4,"pdf","dlda notes",new Date(01/01/1997),"fgdfg");
        ar[2]= new File(new Long(1234567891),new Long(600122),new Long(21),5,4,"pdf","cg notes",new Date(01/01/1997),"fgdfg");
        ...
        for(int i=0;i<6;i++)
        {
            if(ar[i].sap_id==new Long(600122))
                documents.add(ar[i]);
